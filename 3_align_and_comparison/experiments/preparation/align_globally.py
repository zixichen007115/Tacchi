...
def preview(generator):
    ...
    img, img_sim, path = load_single_img('unaligned/real', 'unaligned/sim', 641, resize=False)
    # img, img_sim, path = load_single_img('unaligned/real_', 'unaligned/sim', 641, resize=False)
