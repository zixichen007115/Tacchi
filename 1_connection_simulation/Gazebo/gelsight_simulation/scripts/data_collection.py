...
def collect_data():
    ...
    print('START.')
    move(0, 0, start_z, force=True, wait=5)
    ...
    # move(start_x, start_y, start_z - 1 * z_step_size)
    move(start_x, start_y, start_z + 3 * z_step_size, wait=5)  # 20 for sim, 60 for real
    ...
    k = 0
    BASE = '/home/czx/catkin_ws/src/gelsight_simulation/dataset/sim/exp3'
    BASE_DEPTH = '/home/czx/catkin_ws/src/gelsight_simulation/dataset/sim/depth3'
